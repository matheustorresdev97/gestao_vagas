...
public class CandidateModel {
    ...
    @Schema(example = "Matheus Torres", requiredMode = RequiredMode.REQUIRED, description = "Nome do candidato")
    private String name;
    ...
    @Schema(example = "matheus@gmail.com", requiredMode = RequiredMode.REQUIRED, description = "E-mail do candidato")
